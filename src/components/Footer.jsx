...
import {Facebook, Instagram, Pinterest, Twitter, Phone, MailOutline, Room} from '@mui/icons-material';
    ...
    <Container>
        ...
        <Center>
            ...
            <List>
                ...
                <ListItem>Action Games</ListItem>
                <ListItem>Adventure Games</ListItem>
                <ListItem>Shooting Games</ListItem>
        ...
        <ContactItem>
          <Phone style={{marginRight:"10px"}}/> +91 888888888
        </ContactItem>
        <ContactItem>
          <MailOutline style={{marginRight:"10px"}} /> contact@avi.dev
        </ContactItem>
